...
VIEW_TOP_SIMILAR='15'  # For exel '15'. For the violin, it is necessary to have value ''
TOP_TYPE='top' # 'top', 'equal' # equal don't work with pandas print
REMOVE_DIMENSIONS_LIST='results/theta-001to011/results_theta_0-05.txt' # '' , 'results/theta-001to005/results_theta_same_values.txt'
REPETITIONS=1
...
VIEW_TOP_SIMILAR='15'  # For exel '15'. For the violin, it is necessary to have value ''
TOP_TYPE='top' # 'top', 'equal' # equal don't work with pandas print
REMOVE_DIMENSIONS_LIST='results/theta-001to011/same_values/results_theta_0-05_same_values.txt' # '' , 'results/theta-001to005/results_theta_same_values.txt'
REPETITIONS=1000
BIAS_TYPE='random_text' #'same_as_selected','random_text','random' Used with remove-dimensions-list, if remove-dimensions-list is empty, this parameter is ignored
...
FT_OPEN_CLIP='False'
GPU=0 # 0->4, 1->6, 2->7, 3->0, 4->1, 6 -> 3, 7 -> 5
DATASET_PATH="/hadatasets/MMBias/data"
RUDE_LEVEL=0
# | for space and , for and
CONCEPTS='Disability/Mental|Disability,Disability/Non-Disabled,Disability/Physical|Disability,Nationality/American,Nationality/Arab,Nationality/Chinese,Nationality/Mexican,Religion/Buddhist,Religion/Christian,Religion/Hindu,Religion/Jewish,Religion/Muslim,Sexual|Orientation/Heterosexual,Sexual|Orientation/LGBT'
...
VIEW_TOP_SIMILAR='15'  # For exel '15'. For the violin, it is necessary to have value ''
TOP_TYPE='top' # 'top', 'equal' # equal don't work with pandas print
REMOVE_DIMENSIONS_LIST='results/new_words/theta-001to005/en_results_theta_0-05.txt' # '' , 'results/theta-001to005/results_theta_same_values.txt'
REPETITIONS=1
BIAS_TYPE='same_as_selected' #'same_as_selected','random_text','random' Used with remove-dimensions-list, if remove-dimensions-list is empty, this parameter is ignored
...
VIEW_TOP_SIMILAR='15'  # For exel '15'. For the violin, it is necessary to have value ''
TOP_TYPE='top' # 'top', 'equal' # equal don't work with pandas print
REMOVE_DIMENSIONS_LIST='results/new_words/theta-001to005/pt_results_theta_0-05.txt' # '' , 'results/theta-001to005/results_theta_same_values.txt'
REPETITIONS=1
BIAS_TYPE='same_as_selected' #'same_as_selected','random_text','random' Used with remove-dimensions-list, if remove-dimensions-list is empty, this parameter is ignored
...
VIEW_TOP_SIMILAR='15'  # For exel '15'. For the violin, it is necessary to have value ''
TOP_TYPE='top' # 'top', 'equal' # equal don't work with pandas print
REMOVE_DIMENSIONS_LIST='results/pt-theta-001to005/pt-br-results_theta_same_values.txt' # '' , 'results/theta-001to005/results_theta_same_values.txt'
REPETITIONS=1000
BIAS_TYPE='random_text' #'same_as_selected','random_text','random' Used with remove-dimensions-list, if remove-dimensions-list is empty, this parameter is ignored
...
VIEW_TOP_SIMILAR='15'  # For exel '15'. For the violin, it is necessary to have value ''
TOP_TYPE='top' # 'top', 'equal' # equal don't work with pandas print
REMOVE_DIMENSIONS_LIST='results/new_words/theta-001to005/same_values/pt_results_theta_0-05_same_values.txt' # '' , 'results/theta-001to005/results_theta_same_values.txt'
REPETITIONS=1000
BIAS_TYPE='random_text' #'same_as_selected','random_text','random' Used with remove-dimensions-list, if remove-dimensions-list is empty, this parameter is ignored
