...
BIAS_TYPE='random_A_B' #random_A_B, same_as_X'  Used with remove-dimensions-list, if remove-dimensions-list is empty, this parameter is ignored
...
${PYTHON_BIN} /hahomes/${USER}/FairPIVARA/main.py \
